...
namespace TierList.Persistence.Postgres.Migrations
{
    ...
    [Migration("20250718090618_RichDomainModels")]
    partial class RichDomainModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TierList.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TierList.Domain.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TierList.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("TierList.Domain.Entities.User", "User")
            ...
            modelBuilder.Entity("TierList.Domain.Entities.TierImageContainer", b =>
                {
                    b.HasOne("TierList.Domain.Entities.TierListEntity", null)
                        .WithMany("Containers")
            ...
            modelBuilder.Entity("TierList.Domain.Entities.TierImageEntity", b =>
                {
                    b.HasOne("TierList.Domain.Entities.TierImageContainer", null)
                        .WithMany("Images")
            ...
            modelBuilder.Entity("TierList.Domain.Entities.TierListEntity", b =>
                {
                    b.HasOne("TierList.Domain.Entities.User", null)
                        .WithMany("TierLists")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
